import{_ as Ot,k as R,i as rt,o as Ut,b as $,c as C,d as z,f as K,g as ct,e as Lt,s as at,G as Xt,F as qt,r as Ft,h as ot,n as St,l as V,j as y,H as Yt,q as Qt,t as Jt,E as Mt,I as te,J as ee,K as re,L as ae,u as oe}from"./index-CeZ08cOO.js";import{a as dt}from"./api-Bm0ghaWz.js";const ie={class:"page-stack"},se={key:0,class:"page-state schedule-board-state"},le={key:2,class:"schedule-poster-section"},ne={class:"schedule-poster-frame"},ce={class:"schedule-poster-toolbar"},de={key:1,class:"schedule-poster-action-layer"},fe=["data-state","disabled","aria-label","onClick"],ue=7*24*60*60*1e3,he={__name:"CoursesView",setup(ge){const k=R(!1),_=R(""),N=R([]),g=R(rt(new Date)),b=R("");let Z=0;const p=e=>String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),Tt=(e,t)=>{const r=String(e??"");return r.length<=t?r:`${r.slice(0,Math.max(0,t-1))}…`},O=e=>Array.from(String(e??"")).reduce((t,r)=>t+(/[\u0000-\u00ff]/.test(r)?.55:1),0),ft=(e,t)=>{const r=String(e??"");if(O(r)<=t)return r;let a="";for(const o of Array.from(r)){const i=`${a}${o}`;if(O(`${i}…`)>t)break;a=i}return`${a}…`},It=(e,t,r)=>{const a=(e??[]).map(s=>String(s??"").trim()).filter(Boolean);if(!a.length||t<=0||r<=0)return[];const o=[];let i=0;for(;i<a.length&&o.length<r;){let s="";for(;i<a.length;){const l=s?`、${a[i]}`:a[i];if(O(`${s}${l}`)<=t){s+=l,i+=1;continue}s||(s=ft(a[i],t),i+=1);break}if(!s)break;o.push(s)}if(i<a.length&&o.length){const s=`等${a.length}位`,l=Math.max(3,t-O(s));o[o.length-1]=`${ft(o[o.length-1],l)}${s}`}return o},D=e=>{const t=new Date(e);return t.getHours()*60+t.getMinutes()},Ct=e=>{const t=Math.floor(e/60);return`${String(t).padStart(2,"0")}:00`},_t=e=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(e)}`,Nt=()=>{if(!L.value||typeof window>"u"||typeof document>"u")return;const e=document.createElement("iframe");e.setAttribute("aria-hidden","true"),e.style.position="fixed",e.style.width="0",e.style.height="0",e.style.border="0",e.style.right="0",e.style.bottom="0",document.body.appendChild(e);const t=()=>{window.setTimeout(()=>{document.body.contains(e)&&document.body.removeChild(e)},300)},r=e.contentWindow;if(!r){t();return}const a=p(`${gt.value} ${ut.value}`);r.document.open(),r.document.write(`
  ...
  `),r.document.close();const o=r.document.getElementById("poster"),i=()=>{r.focus(),r.print()};if(r.onafterprint=t,o!=null&&o.complete){window.setTimeout(i,120);return}o==null||o.addEventListener("load",()=>{window.setTimeout(i,120)},{once:!0}),o==null||o.addEventListener("error",t,{once:!0})},U=async(e=g.value)=>{const t=++Z;k.value=!0,_.value="",N.value=[];try{const r=await dt.listWeekSchedules(ot(e));if(t!==Z)return;N.value=r??[]}catch(r){if(t!==Z)return;_.value=St(r,"课表加载失败")}finally{t===Z&&(k.value=!1)}},Dt=(e,t)=>{const r=new Set((e??[]).map(a=>String(a)));N.value=(N.value??[]).map(a=>r.has(String(a.id))?{...a,status:t}:a)},Gt=y(()=>(N.value??[]).slice().sort((e,t)=>new Date(e.startTime)-new Date(t.startTime)).map(e=>{const t=String(e.status??"").toUpperCase()==="COMPLETED";return{...e,scheduleId:e.id,studentName:e.studentName??"未命名",subject:e.subject??"正式课",timeRange:oe(e.startTime,e.endTime),isCompleted:t}})),w=y(()=>{const e=new Map;return Gt.value.forEach(t=>{const r=ot(t.startTime),a=[r,t.startTime,t.endTime,t.subject].join("|"),o=e.get(a);if(o){o.scheduleIds.push(t.scheduleId),o.studentIds.add(t.studentId??t.scheduleId),o.studentNames.add(t.studentName),t.isCompleted?o.completedScheduleIds.push(t.scheduleId):o.pendingScheduleIds.push(t.scheduleId);return}e.set(a,{groupKey:a,dateKey:r,startTime:t.startTime,endTime:t.endTime,sortTime:new Date(t.startTime).getTime(),timeRange:t.timeRange,subject:t.subject,scheduleIds:[t.scheduleId],completedScheduleIds:t.isCompleted?[t.scheduleId]:[],pendingScheduleIds:t.isCompleted?[]:[t.scheduleId],studentIds:new Set([t.studentId??t.scheduleId]),studentNames:new Set([t.studentName])})}),Array.from(e.values()).map(t=>{const r=Array.from(t.studentNames),a=t.studentIds.size||t.scheduleIds.length,o=t.completedScheduleIds.length,i=t.pendingScheduleIds.length,s=o===t.scheduleIds.length,l=o>0&&i>0;return{groupKey:t.groupKey,dateKey:t.dateKey,startTime:t.startTime,endTime:t.endTime,sortTime:t.sortTime,timeRange:t.timeRange,subject:t.subject,scheduleIds:t.scheduleIds,completedScheduleIds:t.completedScheduleIds,pendingScheduleIds:t.pendingScheduleIds,participantCount:a,participantLabel:`共 ${a} 位学员`,studentNames:r,studentNamesLabel:r.join("、"),completedCount:o,pendingCount:i,isCompleted:s,isPartial:l,sessionNote:a>1?"小组课":"单人课"}}).sort((t,r)=>t.sortTime-r.sortTime)}),X=y(()=>{const e=ot(new Date);return ee(g.value).map(t=>{const r=ot(t),a=t.getDay(),o=w.value.filter(i=>i.dateKey===r);return{dateKey:r,weekday:ae(t),dateLabel:re(t),dateNumber:`${t.getDate()}`.padStart(2,"0"),monthLabel:`${t.getMonth()+1}月`,isToday:r===e,isWeekend:a===0||a===6,items:o}})}),ut=y(()=>te(g.value)),Ht=y(()=>{const e=g.value?g.value.getTime():0,t=rt(new Date).getTime();return Math.round((e-t)/ue)}),ht=y(()=>{const e=Ht.value;return e===0?"本周":e===-1?"上周":e===1?"下周":e>0?`${e} 周后`:`${Math.abs(e)} 周前`}),gt=y(()=>`${ht.value}课程表`),Wt=e=>e.isCompleted?"已销课":"待销课",At=e=>e.isCompleted?`取消 ${e.timeRange} ${e.subject} 的销课`:e.isPartial?`继续为 ${e.timeRange} ${e.subject} 销课`:`为 ${e.timeRange} ${e.subject} 销课`,pt=async e=>{const t=new Date(g.value);t.setDate(t.getDate()+e*7),g.value=rt(t),await U(g.value)},Bt=async()=>{g.value=rt(new Date),await U(g.value)},Et=async e=>{if(!e||b.value)return;const t=!e.isCompleted,r=t?e.pendingScheduleIds:e.completedScheduleIds;if(r.length){b.value=e.groupKey;try{for(const a of r)t?await dt.completeSchedule(a):await dt.undoCompleteSchedule(a);Dt(r,t?"COMPLETED":"PLANNED"),Mt.success(t?"已销课":"已恢复为待上课")}catch(a){Mt.error(St(a,t?"销课失败":"恢复待上课失败")),await U(g.value)}finally{b.value=""}}},mt=()=>{if(!X.value.length)return null;const e=1600,t=36,r=122,a=12,o=Math.floor((e-t*2-r-a*6)/7),i=162,s=78,l=38,q=8*60,F=22*60;let x=q,f=F;if(w.value.length){const B=Math.min(...w.value.map(j=>D(j.startTime))),E=Math.max(...w.value.map(j=>D(j.endTime)));x=Math.max(7*60,Math.floor(B/60)*60-60),f=Math.min(23*60,Math.ceil(E/60)*60+60),f-x<8*60&&(f=Math.min(23*60,x+8*60))}const Y=Math.max(1,Math.ceil((f-x)/60)),Q=84,m=t+i+s,v=Y*Q,S=m+v,J=S+l,G=t+r,M=t+i,H=new Map(X.value.map((B,E)=>[B.dateKey,E])),W=7*o+6*a,T=e-t*2,tt=i-24,et=t+24,A=M-16,it=S-A,st=G-24,lt=t+12,nt=r-42;return{width:e,height:J,outerPadding:t,leftRail:r,columnGap:a,columnWidth:o,headerHeight:i,dayHeaderHeight:s,bottomPadding:l,visibleStart:x,visibleEnd:f,hourRows:Y,hourHeight:Q,gridTop:m,gridHeight:v,gridBottom:S,gridLeft:G,dayHeaderTop:M,dayIndexMap:H,gridAreaWidth:W,titlePanelWidth:T,titlePanelHeight:tt,titleTextX:et,boardPanelY:A,boardPanelHeight:it,timelineAxisX:st,timelineLabelX:lt,timelineLabelWidth:nt,timelineLabelHeight:28}},jt=e=>e.isCompleted?{fill:"#f0fdf4",stroke:"#86efac",accent:"#22c55e",badge:"#dcfce7",badgeText:"#15803d"}:e.isPartial?{fill:"#eff6ff",stroke:"#93c5fd",accent:"#3b82f6",badge:"#dbeafe",badgeText:"#1d4ed8"}:{fill:"#fff7ed",stroke:"#fdba74",accent:"#f59e0b",badge:"#ffedd5",badgeText:"#c2410c"},bt=(e,t)=>{const r=t.dayIndexMap.get(e.dateKey);if(r===void 0)return null;const a=t.gridLeft+r*(t.columnWidth+t.columnGap)+10,o=t.gridTop+(D(e.startTime)-t.visibleStart)/60*t.hourHeight+8,i=t.columnWidth-20,s=Math.max(76,(D(e.endTime)-D(e.startTime))/60*t.hourHeight-12);return{x:a,y:o,width:i,height:s,compact:s<102}},$t=y(()=>{const e=mt();return e?w.value.map(t=>{const r=bt(t,e);return r?{...t,label:Wt(t),ariaLabel:At(t),state:t.isCompleted?"completed":t.isPartial?"partial":"pending",style:{top:`${(r.y+(r.compact?r.height/2:r.height-26))/e.height*100}%`,left:`${(r.x+14)/e.width*100}%`}}:null}).filter(Boolean):[]}),L=y(()=>{const e=mt();if(!e)return"";const{width:t,height:r,outerPadding:a,leftRail:o,columnGap:i,columnWidth:s,dayHeaderHeight:l,visibleStart:q,hourRows:F,hourHeight:x,gridTop:f,gridHeight:Y,gridBottom:Q,gridLeft:m,dayHeaderTop:v,gridAreaWidth:S,titlePanelWidth:J,titlePanelHeight:G,titleTextX:M,boardPanelY:H,boardPanelHeight:W,timelineAxisX:T,timelineLabelX:tt,timelineLabelWidth:et,timelineLabelHeight:A}=e,it=X.value.map((n,c)=>{const d=m+c*(s+i),u=n.isToday?"#dbeafe":n.isWeekend?"#f0f9ff":"#ffffff",h=n.isToday?"#60a5fa":"#dbe7f3",I=n.items.length?`${n.items.length} 节课`:"空档";return`
      <g>
        ...
        <text x="${d+s-18}" y="${v+54}" text-anchor="end" font-size="12" fill="${n.isToday?"#2563eb":"#94a3b8"}">${p(n.isToday?"今天":I)}</text>
      </g>
    ...
    <g>
      ...
      ${Array.from({length:F},(n,c)=>{const u=f+c*x+8,h=u+A/2,I=T+10,P=m-8;return`
          <g>
            <rect x="${tt}" y="${u}" width="${et}" height="${A}" rx="14" fill="rgba(255,255,255,0.92)" stroke="rgba(191,219,254,0.92)" />
            <text x="${tt+et/2}" y="${u+18}" text-anchor="middle" font-size="12" font-weight="700" fill="#475569">${p(Ct(q+c*60))}</text>
            <circle cx="${T}" cy="${h}" r="5" fill="#ffffff" stroke="#93c5fd" stroke-width="3" />
            <line x1="${I}" y1="${h}" x2="${P}" y2="${h}" stroke="rgba(191,219,254,0.78)" stroke-width="2" stroke-linecap="round" />
          </g>
        `}).join("")}
    </g>
  `,yt=w.value.map(n=>{const c=bt(n,e);if(!c)return"";const d=jt(n),u=c.x,h=c.y,I=c.width,P=c.height,xt=10,kt=u+3,wt=c.compact,Pt=h+80,Rt=Math.max(1,Math.min(4,Math.floor((P-92)/14))),zt=Math.max(8,Math.floor((I-44)/12)),vt=(wt?[]:It(n.studentNames,zt,Rt)).map((Kt,Vt)=>{const Zt=Vt===0?0:15;return`<tspan x="${u+14}" dy="${Zt}">${p(Kt)}</tspan>`}).join("");return`
      <g filter="url(#cardShadow)">
        <rect x="${u}" y="${h}" width="${I}" height="${P}" rx="20" fill="${d.fill}" stroke="${d.stroke}" />
  ...
  `,j=`
    <svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${r}" viewBox="0 0 ${t} ${r}">
      ...
      <rect x="${a}" y="${a}" width="${J}" height="${G}" rx="34" fill="url(#headerGlass)" stroke="rgba(255,255,255,0.88)" />
      <rect x="${a+14}" y="${a+14}" width="${J-28}" height="${G-28}" rx="28" fill="rgba(255,255,255,0.12)" stroke="rgba(191,219,254,0.38)" />
      <rect x="${a}" y="${H}" width="${o-18}" height="${W}" rx="30" fill="url(#boardGlass)" stroke="rgba(203,213,225,0.82)" />
      <rect x="${a+10}" y="${H+14}" width="${o-38}" height="${W-28}" rx="24" fill="rgba(255,255,255,0.30)" stroke="rgba(255,255,255,0.42)" />
      <rect x="${m-18}" y="${H}" width="${S+36}" height="${W}" rx="34" fill="url(#boardGlass)" stroke="rgba(191,219,254,0.82)" />
  ...
  `;return _t(j)});return Ut(async()=>{await U()}),(e,t)=>{const r=V("el-alert"),a=V("el-button"),o=V("el-image"),i=V("el-empty"),s=V("el-card");return $(),C("section",ie,[z(s,{shadow:"never",class:"schedule-board-card"},{default:K(()=>[k.value?($(),C("div",se,"课表加载中…")):_.value?($(),ct(r,{key:1,title:_.value,type:"error","show-icon":"",closable:!1,class:"schedule-board-alert"},null,8,["title"])):($(),C("div",le,[Lt("div",ne,[Lt("div",ce,[z(a,{class:"schedule-toolbar-button",disabled:k.value||!!b.value,onClick:t[0]||(t[0]=l=>pt(-1))},{default:K(()=>[...t[2]||(t[2]=[at(" 上一周 ",-1)])]),_:1},8,["disabled"]),z(a,{class:"schedule-toolbar-button",disabled:k.value||!!b.value,onClick:Bt},{default:K(()=>[...t[3]||(t[3]=[at(" 回到本周 ",-1)])]),_:1},8,["disabled"]),z(a,{class:"schedule-toolbar-button",disabled:k.value||!!b.value,onClick:t[1]||(t[1]=l=>pt(1))},{default:K(()=>[...t[4]||(t[4]=[at(" 下一周 ",-1)])]),_:1},8,["disabled"]),z(a,{class:"schedule-toolbar-button",disabled:k.value||!!b.value||!!_.value||!L.value,onClick:Nt},{default:K(()=>[...t[5]||(t[5]=[at(" 打印课表 ",-1)])]),_:1},8,["disabled"])]),L.value?($(),ct(o,{key:0,src:L.value,"preview-src-list":[L.value],class:"schedule-poster-image",fit:"contain","preview-teleported":"","hide-on-click-modal":""},null,8,["src","preview-src-list"])):Xt("",!0),$t.value.length?($(),C("div",de,[($(!0),C(qt,null,Ft($t.value,l=>($(),C("button",{key:l.groupKey,type:"button",class:"schedule-session-action","data-state":l.state,disabled:!!b.value,style:Qt(l.style),"aria-label":l.ariaLabel,onClick:Yt(q=>Et(l),["stop"])},Jt(b.value===l.groupKey?"处理中":l.label),13,fe))),128))])):($(),ct(i,{key:2,description:"该周暂无排课安排","image-size":72}))])]))]),_:1})])}}},$e=Ot(he,[["__scopeId","data-v-9047dd10"]]);export{$e as default};
